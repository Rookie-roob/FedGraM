...
from Server.ServerAvg_origin import FedAvg
...
def main(dataset, algorithm,batch_size, learning_rate,num_glob_iters,
    ...
    for i in range(times):
        ...
        # select algorithm
        if(algorithm == "FedAvg"):
            server = FedAvg(device, dataset, algorithm, model, batch_size, learning_rate,num_glob_iters, local_epochs,n_attackers,attacker_type, iid,int(numusers*select_users_ratio),datadir,beta,partition,numusers,localstep)
        server.train()
