...
class UserMinMax(Userbase):
    ...
    def get_malicious_model_state(self, selected_users):
        ...
        malicious_param = self.generated_malicious_param_MinMax(user_param).cpu()
    ...
    def generated_malicious_param_MinMax(self,all_updates,dev_type='std',lamda=30):
        ...
        lamda = torch.Tensor([lamda]).float().cuda()
        # print(lamda)
        threshold_diff = 1e-5
        lamda_fail = lamda
        lamda_succ = 0
