...
class FedBraum(Server):
    def __init__(self, device, dataset, algorithm, model, batch_size, learning_rate, num_glob_iters, local_epochs,
                 n_attackers, attacker_type, iid, select_users, datadir, beta, partition, numusers, localstep,support_dataset_param):
    ...
    def train(self):
        ...
        for glob_iter in range(self.num_glob_iters):
            ...
            self.remove_users_by_norm(remove_num=10,cur_matrix_dict=ret,if_save_norm=True)
